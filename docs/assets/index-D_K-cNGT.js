...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ea,depthTest:!1,depthWrite:!1})}function Qb(r,e,i){const s=new Float32Array(Is),l=new $(0,1,0);return new Ki({name:"SphericalGaussianBlur",defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Kc(),fragmentShader:`
