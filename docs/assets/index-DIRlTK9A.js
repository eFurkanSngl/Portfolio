...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function U_(){return new Ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kc(),fragmentShader:`
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function N_(){return new Ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kc(),fragmentShader:`
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function Kc(){return`
...
}`,BA=[new $(1,0,0),new $(-1,0,0),new $(0,1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1)],GA=[new $(0,-1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1),new $(0,-1,0),new $(0,-1,0)],Z_=new ln,Wo=new $,Vd=new $;function HA(r,e,i){let s=new Zh;const l=new ft,c=new ft,d=new en,p=new ZM,m=new KM,h={},x=i.maxTextureSize,y={[cs]:Kn,[Kn]:cs,[Sa]:Sa},g=new Ki({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ft},radius:{value:4}},vertexShader:IA,fragmentShader:FA}),S=g.clone();S.defines.HORIZONTAL_PASS=1;const A=new Ei;A.setAttribute("position",new ji(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const L=new Zn(A,g),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Pc;let v=this.type;this.render=function(U,z,E){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||U.length===0)return;this.type===sv&&(nt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Pc);const D=r.getRenderTarget(),V=r.getActiveCubeFace(),k=r.getActiveMipmapLevel(),q=r.state;q.setBlending(ba),q.buffers.depth.getReversed()===!0?q.buffers.color.setClear(0,0,0,0):q.buffers.color.setClear(1,1,1,1),q.buffers.depth.setTest(!0),q.setScissorTest(!1);const ce=v!==this.type;ce&&z.traverse(function(pe){pe.material&&(Array.isArray(pe.material)?pe.material.forEach(Q=>Q.needsUpdate=!0):pe.material.needsUpdate=!0)});for(let pe=0,Q=U.length;pe<Q;pe++){const B=U[pe],H=B.shadow;if(H===void 0){nt("WebGLShadowMap:",B,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;l.copy(H.mapSize);const ee=H.getFrameExtents();l.multiply(ee),c.copy(H.mapSize),(l.x>x||l.y>x)&&(l.x>x&&(c.x=Math.floor(x/ee.x),l.x=c.x*ee.x,H.mapSize.x=c.x),l.y>x&&(c.y=Math.floor(x/ee.y),l.y=c.y*ee.y,H.mapSize.y=c.y));const _e=r.state.buffers.depth.getReversed();if(H.camera._reversedDepth=_e,H.map===null||ce===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===qo){if(B.isPointLight){nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Yi(l.x,l.y,{format:Vs,type:Ta,minFilter:In,magFilter:In,generateMipmaps:!1}),H.map.texture.name=B.name+".shadowMap",H.map.depthTexture=new Hr(l.x,l.y,Xi),H.map.depthTexture.name=B.name+".shadowMapDepth",H.map.depthTexture.format=Aa,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Un,H.map.depthTexture.magFilter=Un}else B.isPointLight?(H.map=new zv(l.x),H.map.depthTexture=new kM(l.x,Zi)):(H.map=new Yi(l.x,l.y),H.map.depthTexture=new Hr(l.x,l.y,Zi)),H.map.depthTexture.name=B.name+".shadowMap",H.map.depthTexture.format=Aa,this.type===Pc?(H.map.depthTexture.compareFunction=_e?qh:Wh,H.map.depthTexture.minFilter=In,H.map.depthTexture.magFilter=In):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Un,H.map.depthTexture.magFilter=Un);H.camera.updateProjectionMatrix()}const Ee=H.map.isWebGLCubeRenderTarget?6:1;for(let w=0;w<Ee;w++){if(H.map.isWebGLCubeRenderTarget)r.setRenderTarget(H.map,w),r.clear();else{w===0&&(r.setRenderTarget(H.map),r.clear());const X=H.getViewport(w);d.set(c.x*X.x,c.y*X.y,c.x*X.z,c.y*X.w),q.viewport(d)}if(B.isPointLight){const X=H.camera,me=H.matrix,Ce=B.distance||X.far;Ce!==X.far&&(X.far=Ce,X.updateProjectionMatrix()),Wo.setFromMatrixPosition(B.matrixWorld),X.position.copy(Wo),Vd.copy(X.position),Vd.add(BA[w]),X.up.copy(GA[w]),X.lookAt(Vd),X.updateMatrixWorld(),me.makeTranslation(-Wo.x,-Wo.y,-Wo.z),Z_.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Z_,X.coordinateSystem,X.reversedDepth)}else H.updateMatrices(B);s=H.getFrustum(),T(z,E,H.camera,B,this.type)}H.isPointLightShadow!==!0&&this.type===qo&&O(H,E),H.needsUpdate=!1}v=this.type,M.needsUpdate=!1,r.setRenderTarget(D,V,k)};function O(U,z){const E=e.update(L);g.defines.VSM_SAMPLES!==U.blurSamples&&(g.defines.VSM_SAMPLES=U.blurSamples,S.defines.VSM_SAMPLES=U.blurSamples,g.needsUpdate=!0,S.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new Yi(l.x,l.y,{format:Vs,type:Ta})),g.uniforms.shadow_pass.value=U.map.depthTexture,g.uniforms.resolution.value=U.mapSize,g.uniforms.radius.value=U.radius,r.setRenderTarget(U.mapPass),r.clear(),r.renderBufferDirect(z,null,E,g,L,null),S.uniforms.shadow_pass.value=U.mapPass.texture,S.uniforms.resolution.value=U.mapSize,S.uniforms.radius.value=U.radius,r.setRenderTarget(U.map),r.clear(),r.renderBufferDirect(z,null,E,S,L,null)}function I(U,z,E,D){let V=null;const k=E.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(k!==void 0)V=k;else if(V=E.isPointLight===!0?m:p,r.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const q=V.uuid,ce=z.uuid;let pe=h[q];pe===void 0&&(pe={},h[q]=pe);let Q=pe[ce];Q===void 0&&(Q=V.clone(),pe[ce]=Q,z.addEventListener("dispose",N)),V=Q}if(V.visible=z.visible,V.wireframe=z.wireframe,D===qo?V.side=z.shadowSide!==null?z.shadowSide:z.side:V.side=z.shadowSide!==null?z.shadowSide:y[z.side],V.alphaMap=z.alphaMap,V.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,V.map=z.map,V.clipShadows=z.clipShadows,V.clippingPlanes=z.clippingPlanes,V.clipIntersection=z.clipIntersection,V.displacementMap=z.displacementMap,V.displacementScale=z.displacementScale,V.displacementBias=z.displacementBias,V.wireframeLinewidth=z.wireframeLinewidth,V.linewidth=z.linewidth,E.isPointLight===!0&&V.isMeshDistanceMaterial===!0){const q=r.properties.get(V);q.light=E}return V}function T(U,z,E,D,V){if(U.visible===!1)return;if(U.layers.test(z.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&V===qo)&&(!U.frustumCulled||s.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(E.matrixWorldInverse,U.matrixWorld);const ce=e.update(U),pe=U.material;if(Array.isArray(pe)){const Q=ce.groups;for(let B=0,H=Q.length;B<H;B++){const ee=Q[B],_e=pe[ee.materialIndex];if(_e&&_e.visible){const Ee=I(U,_e,D,V);U.onBeforeShadow(r,U,z,E,ce,Ee,ee),r.renderBufferDirect(E,null,ce,Ee,U,ee),U.onAfterShadow(r,U,z,E,ce,Ee,ee)}}}else if(pe.visible){const Q=I(U,pe,D,V);U.onBeforeShadow(r,U,z,E,ce,Q,null),r.renderBufferDirect(E,null,ce,Q,U,null),U.onAfterShadow(r,U,z,E,ce,Q,null)}}const q=U.children;for(let ce=0,pe=q.length;ce<pe;ce++)T(q[ce],z,E,D,V)}function N(U){U.target.removeEventListener("dispose",N);for(const E in h){const D=h[E],V=U.target.uuid;V in D&&(D[V].dispose(),delete D[V])}}}function VA(r,e){function i(){let Y=!1;const Ae=new en;let ve=null;const we=new en(0,0,0,0);return{setMask:function(Ie){ve!==Ie&&!Y&&(r.colorMask(Ie,Ie,Ie,Ie),ve=Ie)},setLocked:function(Ie){Y=Ie},setClear:function(Ie,Me,qe,Ve,Kt){Kt===!0&&(Ie*=Ve,Me*=Ve,qe*=Ve),Ae.set(Ie,Me,qe,Ve),we.equals(Ae)===!1&&(r.clearColor(Ie,Me,qe,Ve),we.copy(Ae))},reset:function(){Y=!1,ve=null,we.set(-1,0,0,0)}}}function s(){let Y=!1,Ae=!1,ve=null,we=null,Ie=null;return{setReversed:function(Me){if(Ae!==Me){const qe=e.get("EXT_clip_control");Me?qe.clipControlEXT(qe.LOWER_LEFT_EXT,qe.ZERO_TO_ONE_EXT):qe.clipControlEXT(qe.LOWER_LEFT_EXT,qe.NEGATIVE_ONE_TO_ONE_EXT),Ae=Me;const Ve=Ie;Ie=null,this.setClear(Ve)}},getReversed:function(){return Ae},setTest:function(Me){Me?be(r.DEPTH_TEST):Ge(r.DEPTH_TEST)},setMask:function(Me){ve!==Me&&!Y&&(r.depthMask(Me),ve=Me)},setFunc:function(Me){if(Ae&&(Me=_M[Me]),we!==Me){switch(Me){case qd:r.depthFunc(r.NEVER);break;case Yd:r.depthFunc(r.ALWAYS);break;case jd:r.depthFunc(r.LESS);break;case Br:r.depthFunc(r.LEQUAL);break;case Zd:r.depthFunc(r.EQUAL);break;case Kd:r.depthFunc(r.GEQUAL);break;case Qd:r.depthFunc(r.GREATER);break;case Jd:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}we=Me}},setLocked:function(Me){Y=Me},setClear:function(Me){Ie!==Me&&(Ie=Me,Ae&&(Me=1-Me),r.clearDepth(Me))},reset:function(){Y=!1,ve=null,we=null,Ie=null,Ae=!1}}}function l(){let Y=!1,Ae=null,ve=null,we=null,Ie=null,Me=null,qe=null,Ve=null,Kt=null;return{setTest:function(Nt){Y||(Nt?be(r.STENCIL_TEST):Ge(r.STENCIL_TEST))},setMask:function(Nt){Ae!==Nt&&!Y&&(r.stencilMask(Nt),Ae=Nt)},setFunc:function(Nt,Qn,Jn){(ve!==Nt||we!==Qn||Ie!==Jn)&&(r.stencilFunc(Nt,Qn,Jn),ve=Nt,we=Qn,Ie=Jn)},setOp:function(Nt,Qn,Jn){(Me!==Nt||qe!==Qn||Ve!==Jn)&&(r.stencilOp(Nt,Qn,Jn),Me=Nt,qe=Qn,Ve=Jn)},setLocked:function(Nt){Y=Nt},setClear:function(Nt){Kt!==Nt&&(r.clearStencil(Nt),Kt=Nt)},reset:function(){Y=!1,Ae=null,ve=null,we=null,Ie=null,Me=null,qe=null,Ve=null,Kt=null}}}const c=new i,d=new s,p=new l,m=new WeakMap,h=new WeakMap;let x={},y={},g={},S=new WeakMap,A=[],L=null,M=!1,v=null,O=null,I=null,T=null,N=null,U=null,z=null,E=new bt(0,0,0),D=0,V=!1,k=null,q=null,ce=null,pe=null,Q=null;const B=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,ee=0;const _e=r.getParameter(r.VERSION);_e.indexOf("WebGL")!==-1?(ee=parseFloat(/^WebGL (\d)/.exec(_e)[1]),H=ee>=1):_e.indexOf("OpenGL ES")!==-1&&(ee=parseFloat(/^OpenGL ES (\d)/.exec(_e)[1]),H=ee>=2);let Ee=null,w={};const X=r.getParameter(r.SCISSOR_BOX),me=r.getParameter(r.VIEWPORT),Ce=new en().fromArray(X),ze=new en().fromArray(me);function se(Y,Ae,ve,we){const Ie=new Uint8Array(4),Me=r.createTexture();r.bindTexture(Y,Me),r.texParameteri(Y,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(Y,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let qe=0;qe<ve;qe++)Y===r.TEXTURE_3D||Y===r.TEXTURE_2D_ARRAY?r.texImage3D(Ae,0,r.RGBA,1,1,we,0,r.RGBA,r.UNSIGNED_BYTE,Ie):r.texImage2D(Ae+qe,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Ie);return Me}const Se={};Se[r.TEXTURE_2D]=se(r.TEXTURE_2D,r.TEXTURE_2D,1),Se[r.TEXTURE_CUBE_MAP]=se(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Se[r.TEXTURE_2D_ARRAY]=se(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Se[r.TEXTURE_3D]=se(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),d.setClear(1),p.setClear(0),be(r.DEPTH_TEST),d.setFunc(Br),tn(!1),nn(Q0),be(r.CULL_FACE),xt(ba);function be(Y){x[Y]!==!0&&(r.enable(Y),x[Y]=!0)}function Ge(Y){x[Y]!==!1&&(r.disable(Y),x[Y]=!1)}function tt(Y,Ae){return g[Y]!==Ae?(r.bindFramebuffer(Y,Ae),g[Y]=Ae,Y===r.DRAW_FRAMEBUFFER&&(g[r.FRAMEBUFFER]=Ae),Y===r.FRAMEBUFFER&&(g[r.DRAW_FRAMEBUFFER]=Ae),!0):!1}function Ke(Y,Ae){let ve=A,we=!1;if(Y){ve=S.get(Ae),ve===void 0&&(ve=[],S.set(Ae,ve));const Ie=Y.textures;if(ve.length!==Ie.length||ve[0]!==r.COLOR_ATTACHMENT0){for(let Me=0,qe=Ie.length;Me<qe;Me++)ve[Me]=r.COLOR_ATTACHMENT0+Me;ve.length=Ie.length,we=!0}}else ve[0]!==r.BACK&&(ve[0]=r.BACK,we=!0);we&&r.drawBuffers(ve)}function Yt(Y){return L!==Y?(r.useProgram(Y),L=Y,!0):!1}const ut={[zs]:r.FUNC_ADD,[GS]:r.FUNC_SUBTRACT,[HS]:r.FUNC_REVERSE_SUBTRACT};ut[VS]=r.MIN,ut[kS]=r.MAX;const vt={[XS]:r.ZERO,[WS]:r.ONE,[qS]:r.SRC_COLOR,[Xd]:r.SRC_ALPHA,[JS]:r.SRC_ALPHA_SATURATE,[KS]:r.DST_COLOR,[jS]:r.DST_ALPHA,[YS]:r.ONE_MINUS_SRC_COLOR,[Wd]:r.ONE_MINUS_SRC_ALPHA,[QS]:r.ONE_MINUS_DST_COLOR,[ZS]:r.ONE_MINUS_DST_ALPHA,[$S]:r.CONSTANT_COLOR,[eM]:r.ONE_MINUS_CONSTANT_COLOR,[tM]:r.CONSTANT_ALPHA,[nM]:r.ONE_MINUS_CONSTANT_ALPHA};function xt(Y,Ae,ve,we,Ie,Me,qe,Ve,Kt,Nt){if(Y===ba){M===!0&&(Ge(r.BLEND),M=!1);return}if(M===!1&&(be(r.BLEND),M=!0),Y!==BS){if(Y!==v||Nt!==V){if((O!==zs||N!==zs)&&(r.blendEquation(r.FUNC_ADD),O=zs,N=zs),Nt)switch(Y){case zr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFunc(r.ONE,r.ONE);break;case $0:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case e_:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Et("WebGLState: Invalid blending: ",Y);break}else switch(Y){case zr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case J0:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case $0:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case e_:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",Y);break}I=null,T=null,U=null,z=null,E.set(0,0,0),D=0,v=Y,V=Nt}return}Ie=Ie||Ae,Me=Me||ve,qe=qe||we,(Ae!==O||Ie!==N)&&(r.blendEquationSeparate(ut[Ae],ut[Ie]),O=Ae,N=Ie),(ve!==I||we!==T||Me!==U||qe!==z)&&(r.blendFuncSeparate(vt[ve],vt[we],vt[Me],vt[qe]),I=ve,T=we,U=Me,z=qe),(Ve.equals(E)===!1||Kt!==D)&&(r.blendColor(Ve.r,Ve.g,Ve.b,Kt),E.copy(Ve),D=Kt),v=Y,V=!1}function dt(Y,Ae){Y.side===Sa?Ge(r.CULL_FACE):be(r.CULL_FACE);let ve=Y.side===Kn;Ae&&(ve=!ve),tn(ve),Y.blending===zr&&Y.transparent===!1?xt(ba):xt(Y.blending,Y.blendEquation,Y.blendSrc,Y.blendDst,Y.blendEquationAlpha,Y.blendSrcAlpha,Y.blendDstAlpha,Y.blendColor,Y.blendAlpha,Y.premultipliedAlpha),d.setFunc(Y.depthFunc),d.setTest(Y.depthTest),d.setMask(Y.depthWrite),c.setMask(Y.colorWrite);const we=Y.stencilWrite;p.setTest(we),we&&(p.setMask(Y.stencilWriteMask),p.setFunc(Y.stencilFunc,Y.stencilRef,Y.stencilFuncMask),p.setOp(Y.stencilFail,Y.stencilZFail,Y.stencilZPass)),cn(Y.polygonOffset,Y.polygonOffsetFactor,Y.polygonOffsetUnits),Y.alphaToCoverage===!0?be(r.SAMPLE_ALPHA_TO_COVERAGE):Ge(r.SAMPLE_ALPHA_TO_COVERAGE)}function tn(Y){k!==Y&&(Y?r.frontFace(r.CW):r.frontFace(r.CCW),k=Y)}function nn(Y){Y!==IS?(be(r.CULL_FACE),Y!==q&&(Y===Q0?r.cullFace(r.BACK):Y===FS?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ge(r.CULL_FACE),q=Y}function an(Y){Y!==ce&&(H&&r.lineWidth(Y),ce=Y)}function cn(Y,Ae,ve){Y?(be(r.POLYGON_OFFSET_FILL),(pe!==Ae||Q!==ve)&&(pe=Ae,Q=ve,d.getReversed()&&(Ae=-Ae),r.polygonOffset(Ae,ve))):Ge(r.POLYGON_OFFSET_FILL)}function Wt(Y){Y?be(r.SCISSOR_TEST):Ge(r.SCISSOR_TEST)}function sn(Y){Y===void 0&&(Y=r.TEXTURE0+B-1),Ee!==Y&&(r.activeTexture(Y),Ee=Y)}function Z(Y,Ae,ve){ve===void 0&&(Ee===null?ve=r.TEXTURE0+B-1:ve=Ee);let we=w[ve];we===void 0&&(we={type:void 0,texture:void 0},w[ve]=we),(we.type!==Y||we.texture!==Ae)&&(Ee!==ve&&(r.activeTexture(ve),Ee=ve),r.bindTexture(Y,Ae||Se[Y]),we.type=Y,we.texture=Ae)}function Bt(){const Y=w[Ee];Y!==void 0&&Y.type!==void 0&&(r.bindTexture(Y.type,null),Y.type=void 0,Y.texture=void 0)}function Ct(){try{r.compressedTexImage2D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function P(){try{r.compressedTexImage3D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function b(){try{r.texSubImage2D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function J(){try{r.texSubImage3D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function re(){try{r.compressedTexSubImage2D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function de(){try{r.compressedTexSubImage3D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function Te(){try{r.texStorage2D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function De(){try{r.texStorage3D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function fe(){try{r.texImage2D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function he(){try{r.texImage3D(...arguments)}catch(Y){Et("WebGLState:",Y)}}function Re(Y){return y[Y]!==void 0?y[Y]:r.getParameter(Y)}function Fe(Y,Ae){y[Y]!==Ae&&(r.pixelStorei(Y,Ae),y[Y]=Ae)}function Le(Y){Ce.equals(Y)===!1&&(r.scissor(Y.x,Y.y,Y.z,Y.w),Ce.copy(Y))}function Ue(Y){ze.equals(Y)===!1&&(r.viewport(Y.x,Y.y,Y.z,Y.w),ze.copy(Y))}function Ze(Y,Ae){let ve=h.get(Ae);ve===void 0&&(ve=new WeakMap,h.set(Ae,ve));let we=ve.get(Y);we===void 0&&(we=r.getUniformBlockIndex(Ae,Y.name),ve.set(Y,we))}function Qe(Y,Ae){const we=h.get(Ae).get(Y);m.get(Ae)!==we&&(r.uniformBlockBinding(Ae,we,Y.__bindingPointIndex),m.set(Ae,we))}function it(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),d.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),r.pixelStorei(r.PACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!1),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,r.BROWSER_DEFAULT_WEBGL),r.pixelStorei(r.PACK_ROW_LENGTH,0),r.pixelStorei(r.PACK_SKIP_PIXELS,0),r.pixelStorei(r.PACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_ROW_LENGTH,0),r.pixelStorei(r.UNPACK_IMAGE_HEIGHT,0),r.pixelStorei(r.UNPACK_SKIP_PIXELS,0),r.pixelStorei(r.UNPACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_SKIP_IMAGES,0),x={},y={},Ee=null,w={},g={},S=new WeakMap,A=[],L=null,M=!1,v=null,O=null,I=null,T=null,N=null,U=null,z=null,E=new bt(0,0,0),D=0,V=!1,k=null,q=null,ce=null,pe=null,Q=null,Ce.set(0,0,r.canvas.width,r.canvas.height),ze.set(0,0,r.canvas.width,r.canvas.height),c.reset(),d.reset(),p.reset()}return{buffers:{color:c,depth:d,stencil:p},enable:be,disable:Ge,bindFramebuffer:tt,drawBuffers:Ke,useProgram:Yt,setBlending:xt,setMaterial:dt,setFlipSided:tn,setCullFace:nn,setLineWidth:an,setPolygonOffset:cn,setScissorTest:Wt,activeTexture:sn,bindTexture:Z,unbindTexture:Bt,compressedTexImage2D:Ct,compressedTexImage3D:P,texImage2D:fe,texImage3D:he,pixelStorei:Fe,getParameter:Re,updateUBOMapping:Ze,uniformBlockBinding:Qe,texStorage2D:Te,texStorage3D:De,texSubImage2D:b,texSubImage3D:J,compressedTexSubImage2D:re,compressedTexSubImage3D:de,scissor:Le,viewport:Ue,reset:it}}function kA(r,e,i,s,l,c,d){const p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new ft,x=new WeakMap,y=new Set;let g;const S=new WeakMap;let A=!1;try{A=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function L(P,b){return A?new OffscreenCanvas(P,b):Wc("canvas")}function M(P,b,J){let re=1;const de=Ct(P);if((de.width>J||de.height>J)&&(re=J/Math.max(de.width,de.height)),re<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const Te=Math.floor(re*de.width),De=Math.floor(re*de.height);g===void 0&&(g=L(Te,De));const fe=b?L(Te,De):g;return fe.width=Te,fe.height=De,fe.getContext("2d").drawImage(P,0,0,Te,De),nt("WebGLRenderer: Texture has been resized from ("+de.width+"x"+de.height+") to ("+Te+"x"+De+")."),fe}else return"data"in P&&nt("WebGLRenderer: Image in DataTexture is too big ("+de.width+"x"+de.height+")."),P;return P}function v(P){return P.generateMipmaps}function O(P){r.generateMipmap(P)}function I(P){return P.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?r.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function T(P,b,J,re,de,Te=!1){if(P!==null){if(r[P]!==void 0)return r[P];nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let De;re&&(De=e.get("EXT_texture_norm16"),De||nt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let fe=b;if(b===r.RED&&(J===r.FLOAT&&(fe=r.R32F),J===r.HALF_FLOAT&&(fe=r.R16F),J===r.UNSIGNED_BYTE&&(fe=r.R8),J===r.UNSIGNED_SHORT&&De&&(fe=De.R16_EXT),J===r.SHORT&&De&&(fe=De.R16_SNORM_EXT)),b===r.RED_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.R8UI),J===r.UNSIGNED_SHORT&&(fe=r.R16UI),J===r.UNSIGNED_INT&&(fe=r.R32UI),J===r.BYTE&&(fe=r.R8I),J===r.SHORT&&(fe=r.R16I),J===r.INT&&(fe=r.R32I)),b===r.RG&&(J===r.FLOAT&&(fe=r.RG32F),J===r.HALF_FLOAT&&(fe=r.RG16F),J===r.UNSIGNED_BYTE&&(fe=r.RG8),J===r.UNSIGNED_SHORT&&De&&(fe=De.RG16_EXT),J===r.SHORT&&De&&(fe=De.RG16_SNORM_EXT)),b===r.RG_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RG8UI),J===r.UNSIGNED_SHORT&&(fe=r.RG16UI),J===r.UNSIGNED_INT&&(fe=r.RG32UI),J===r.BYTE&&(fe=r.RG8I),J===r.SHORT&&(fe=r.RG16I),J===r.INT&&(fe=r.RG32I)),b===r.RGB_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RGB8UI),J===r.UNSIGNED_SHORT&&(fe=r.RGB16UI),J===r.UNSIGNED_INT&&(fe=r.RGB32UI),J===r.BYTE&&(fe=r.RGB8I),J===r.SHORT&&(fe=r.RGB16I),J===r.INT&&(fe=r.RGB32I)),b===r.RGBA_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RGBA8UI),J===r.UNSIGNED_SHORT&&(fe=r.RGBA16UI),J===r.UNSIGNED_INT&&(fe=r.RGBA32UI),J===r.BYTE&&(fe=r.RGBA8I),J===r.SHORT&&(fe=r.RGBA16I),J===r.INT&&(fe=r.RGBA32I)),b===r.RGB&&(J===r.UNSIGNED_SHORT&&De&&(fe=De.RGB16_EXT),J===r.SHORT&&De&&(fe=De.RGB16_SNORM_EXT),J===r.UNSIGNED_INT_5_9_9_9_REV&&(fe=r.RGB9_E5),J===r.UNSIGNED_INT_10F_11F_11F_REV&&(fe=r.R11F_G11F_B10F)),b===r.RGBA){const he=Te?Xc:St.getTransfer(de);J===r.FLOAT&&(fe=r.RGBA32F),J===r.HALF_FLOAT&&(fe=r.RGBA16F),J===r.UNSIGNED_BYTE&&(fe=he===Ft?r.SRGB8_ALPHA8:r.RGBA8),J===r.UNSIGNED_SHORT&&De&&(fe=De.RGBA16_EXT),J===r.SHORT&&De&&(fe=De.RGBA16_SNORM_EXT),J===r.UNSIGNED_SHORT_4_4_4_4&&(fe=r.RGBA4),J===r.UNSIGNED_SHORT_5_5_5_1&&(fe=r.RGB5_A1)}return(fe===r.R16F||fe===r.R32F||fe===r.RG16F||fe===r.RG32F||fe===r.RGBA16F||fe===r.RGBA32F)&&e.get("EXT_color_buffer_float"),fe}function N(P,b){let J;return P?b===null||b===Zi||b===Ko?J=r.DEPTH24_STENCIL8:b===Xi?J=r.DEPTH32F_STENCIL8:b===Zo&&(J=r.DEPTH24_STENCIL8,nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Zi||b===Ko?J=r.DEPTH_COMPONENT24:b===Xi?J=r.DEPTH_COMPONENT32F:b===Zo&&(J=r.DEPTH_COMPONENT16),J}function U(P,b){return v(P)===!0||P.isFramebufferTexture&&P.minFilter!==Un&&P.minFilter!==In?Math.log2(Math.max(b.width,b.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?b.mipmaps.length:1}function z(P){const b=P.target;b.removeEventListener("dispose",z),D(b),b.isVideoTexture&&x.delete(b),b.isHTMLTexture&&y.delete(b)}function E(P){const b=P.target;b.removeEventListener("dispose",E),k(b)}function D(P){const b=s.get(P);if(b.__webglInit===void 0)return;const J=P.source,re=S.get(J);if(re){const de=re[b.__cacheKey];de.usedTimes--,de.usedTimes===0&&V(P),Object.keys(re).length===0&&S.delete(J)}s.remove(P)}function V(P){const b=s.get(P);r.deleteTexture(b.__webglTexture);const J=P.source,re=S.get(J);delete re[b.__cacheKey],d.memory.textures--}function k(P){const b=s.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),s.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let re=0;re<6;re++){if(Array.isArray(b.__webglFramebuffer[re]))for(let de=0;de<b.__webglFramebuffer[re].length;de++)r.deleteFramebuffer(b.__webglFramebuffer[re][de]);else r.deleteFramebuffer(b.__webglFramebuffer[re]);b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer[re])}else{if(Array.isArray(b.__webglFramebuffer))for(let re=0;re<b.__webglFramebuffer.length;re++)r.deleteFramebuffer(b.__webglFramebuffer[re]);else r.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&r.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&r.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let re=0;re<b.__webglColorRenderbuffer.length;re++)b.__webglColorRenderbuffer[re]&&r.deleteRenderbuffer(b.__webglColorRenderbuffer[re]);b.__webglDepthRenderbuffer&&r.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const J=P.textures;for(let re=0,de=J.length;re<de;re++){const Te=s.get(J[re]);Te.__webglTexture&&(r.deleteTexture(Te.__webglTexture),d.memory.textures--),s.remove(J[re])}s.remove(P)}let q=0;function ce(){q=0}function pe(){return q}function Q(P){q=P}function B(){const P=q;return P>=l.maxTextures&&nt("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l.maxTextures),q+=1,P}function H(P){const b=[];return b.push(P.wrapS),b.push(P.wrapT),b.push(P.wrapR||0),b.push(P.magFilter),b.push(P.minFilter),b.push(P.anisotropy),b.push(P.internalFormat),b.push(P.format),b.push(P.type),b.push(P.generateMipmaps),b.push(P.premultiplyAlpha),b.push(P.flipY),b.push(P.unpackAlignment),b.push(P.colorSpace),b.join()}function ee(P,b){const J=s.get(P);if(P.isVideoTexture&&Z(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&J.__version!==P.version){const re=P.image;if(re===null)nt("WebGLRenderer: Texture marked for update but no image data found.");else if(re.complete===!1)nt("WebGLRenderer: Texture marked for update but image is incomplete");else{Ge(J,P,b);return}}else P.isExternalTexture&&(J.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,J.__webglTexture,r.TEXTURE0+b)}function _e(P,b){const J=s.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&J.__version!==P.version){Ge(J,P,b);return}else P.isExternalTexture&&(J.__webglTexture=P.sourceTexture?P.sourceTexture:null);i.bindTexture(r.TEXTURE_2D_ARRAY,J.__webglTexture,r.TEXTURE0+b)}function Ee(P,b){const J=s.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&J.__version!==P.version){Ge(J,P,b);return}i.bindTexture(r.TEXTURE_3D,J.__webglTexture,r.TEXTURE0+b)}function w(P,b){const J=s.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&J.__version!==P.version){tt(J,P,b);return}i.bindTexture(r.TEXTURE_CUBE_MAP,J.__webglTexture,r.TEXTURE0+b)}const X={[$d]:r.REPEAT,[Ma]:r.CLAMP_TO_EDGE,[eh]:r.MIRRORED_REPEAT},me={[Un]:r.NEAREST,[sM]:r.NEAREST_MIPMAP_NEAREST,[dc]:r.NEAREST_MIPMAP_LINEAR,[In]:r.LINEAR,[fd]:r.LINEAR_MIPMAP_NEAREST,[Bs]:r.LINEAR_MIPMAP_LINEAR},Ce={[lM]:r.NEVER,[hM]:r.ALWAYS,[cM]:r.LESS,[Wh]:r.LEQUAL,[uM]:r.EQUAL,[qh]:r.GEQUAL,[fM]:r.GREATER,[dM]:r.NOTEQUAL};function ze(P,b){if(b.type===Xi&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===In||b.magFilter===fd||b.magFilter===dc||b.magFilter===Bs||b.minFilter===In||b.minFilter===fd||b.minFilter===dc||b.minFilter===Bs)&&nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(P,r.TEXTURE_WRAP_S,X[b.wrapS]),r.texParameteri(P,r.TEXTURE_WRAP_T,X[b.wrapT]),(P===r.TEXTURE_3D||P===r.TEXTURE_2D_ARRAY)&&r.texParameteri(P,r.TEXTURE_WRAP_R,X[b.wrapR]),r.texParameteri(P,r.TEXTURE_MAG_FILTER,me[b.magFilter]),r.texParameteri(P,r.TEXTURE_MIN_FILTER,me[b.minFilter]),b.compareFunction&&(r.texParameteri(P,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(P,r.TEXTURE_COMPARE_FUNC,Ce[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===Un||b.minFilter!==dc&&b.minFilter!==Bs||b.type===Xi&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||s.get(b).__currentAnisotropy){const J=e.get("EXT_texture_filter_anisotropic");r.texParameterf(P,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,l.getMaxAnisotropy())),s.get(b).__currentAnisotropy=b.anisotropy}}}function se(P,b){let J=!1;P.__webglInit===void 0&&(P.__webglInit=!0,b.addEventListener("dispose",z));const re=b.source;let de=S.get(re);de===void 0&&(de={},S.set(re,de));const Te=H(b);if(Te!==P.__cacheKey){de[Te]===void 0&&(de[Te]={texture:r.createTexture(),usedTimes:0},d.memory.textures++,J=!0),de[Te].usedTimes++;const De=de[P.__cacheKey];De!==void 0&&(de[P.__cacheKey].usedTimes--,De.usedTimes===0&&V(b)),P.__cacheKey=Te,P.__webglTexture=de[Te].texture}return J}function Se(P,b,J){return Math.floor(Math.floor(P/J)/b)}function be(P,b,J,re){const Te=P.updateRanges;if(Te.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,b.width,b.height,J,re,b.data);else{Te.sort((Fe,Le)=>Fe.start-Le.start);let De=0;for(let Fe=1;Fe<Te.length;Fe++){const Le=Te[De],Ue=Te[Fe],Ze=Le.start+Le.count,Qe=Se(Ue.start,b.width,4),it=Se(Le.start,b.width,4);Ue.start<=Ze+1&&Qe===it&&Se(Ue.start+Ue.count-1,b.width,4)===Qe?Le.count=Math.max(Le.count,Ue.start+Ue.count-Le.start):(++De,Te[De]=Ue)}Te.length=De+1;const fe=i.getParameter(r.UNPACK_ROW_LENGTH),he=i.getParameter(r.UNPACK_SKIP_PIXELS),Re=i.getParameter(r.UNPACK_SKIP_ROWS);i.pixelStorei(r.UNPACK_ROW_LENGTH,b.width);for(let Fe=0,Le=Te.length;Fe<Le;Fe++){const Ue=Te[Fe],Ze=Math.floor(Ue.start/4),Qe=Math.ceil(Ue.count/4),it=Ze%b.width,Y=Math.floor(Ze/b.width),Ae=Qe,ve=1;i.pixelStorei(r.UNPACK_SKIP_PIXELS,it),i.pixelStorei(r.UNPACK_SKIP_ROWS,Y),i.texSubImage2D(r.TEXTURE_2D,0,it,Y,Ae,ve,J,re,b.data)}P.clearUpdateRanges(),i.pixelStorei(r.UNPACK_ROW_LENGTH,fe),i.pixelStorei(r.UNPACK_SKIP_PIXELS,he),i.pixelStorei(r.UNPACK_SKIP_ROWS,Re)}}function Ge(P,b,J){let re=r.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(re=r.TEXTURE_2D_ARRAY),b.isData3DTexture&&(re=r.TEXTURE_3D);const de=se(P,b),Te=b.source;i.bindTexture(re,P.__webglTexture,r.TEXTURE0+J);const De=s.get(Te);if(Te.version!==De.__version||de===!0){if(i.activeTexture(r.TEXTURE0+J),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){const ve=St.getPrimaries(St.workingColorSpace),we=b.colorSpace===rs?null:St.getPrimaries(b.colorSpace),Ie=b.colorSpace===rs||ve===we?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ie)}i.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment);let he=M(b.image,!1,l.maxTextureSize);he=Bt(b,he);const Re=c.convert(b.format,b.colorSpace),Fe=c.convert(b.type);let Le=T(b.internalFormat,Re,Fe,b.normalized,b.colorSpace,b.isVideoTexture);ze(re,b);let Ue;const Ze=b.mipmaps,Qe=b.isVideoTexture!==!0,it=De.__version===void 0||de===!0,Y=Te.dataReady,Ae=U(b,he);if(b.isDepthTexture)Le=N(b.format===Gs,b.type),it&&(Qe?i.texStorage2D(r.TEXTURE_2D,1,Le,he.width,he.height):i.texImage2D(r.TEXTURE_2D,0,Le,he.width,he.height,0,Re,Fe,null));else if(b.isDataTexture)if(Ze.length>0){Qe&&it&&i.texStorage2D(r.TEXTURE_2D,Ae,Le,Ze[0].width,Ze[0].height);for(let ve=0,we=Ze.length;ve<we;ve++)Ue=Ze[ve],Qe?Y&&i.texSubImage2D(r.TEXTURE_2D,ve,0,0,Ue.width,Ue.height,Re,Fe,Ue.data):i.texImage2D(r.TEXTURE_2D,ve,Le,Ue.width,Ue.height,0,Re,Fe,Ue.data);b.generateMipmaps=!1}else Qe?(it&&i.texStorage2D(r.TEXTURE_2D,Ae,Le,he.width,he.height),Y&&be(b,he,Re,Fe)):i.texImage2D(r.TEXTURE_2D,0,Le,he.width,he.height,0,Re,Fe,he.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Qe&&it&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,Le,Ze[0].width,Ze[0].height,he.depth);for(let ve=0,we=Ze.length;ve<we;ve++)if(Ue=Ze[ve],b.format!==Oi)if(Re!==null)if(Qe){if(Y)if(b.layerUpdates.size>0){const Ie=A_(Ue.width,Ue.height,b.format,b.type);for(const Me of b.layerUpdates){const qe=Ue.data.subarray(Me*Ie/Ue.data.BYTES_PER_ELEMENT,(Me+1)*Ie/Ue.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ve,0,0,Me,Ue.width,Ue.height,1,Re,qe)}b.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ve,0,0,0,Ue.width,Ue.height,he.depth,Re,Ue.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,ve,Le,Ue.width,Ue.height,he.depth,0,Ue.data,0,0);else nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Qe?Y&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,ve,0,0,0,Ue.width,Ue.height,he.depth,Re,Fe,Ue.data):i.texImage3D(r.TEXTURE_2D_ARRAY,ve,Le,Ue.width,Ue.height,he.depth,0,Re,Fe,Ue.data)}else{Qe&&it&&i.texStorage2D(r.TEXTURE_2D,Ae,Le,Ze[0].width,Ze[0].height);for(let ve=0,we=Ze.length;ve<we;ve++)Ue=Ze[ve],b.format!==Oi?Re!==null?Qe?Y&&i.compressedTexSubImage2D(r.TEXTURE_2D,ve,0,0,Ue.width,Ue.height,Re,Ue.data):i.compressedTexImage2D(r.TEXTURE_2D,ve,Le,Ue.width,Ue.height,0,Ue.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Qe?Y&&i.texSubImage2D(r.TEXTURE_2D,ve,0,0,Ue.width,Ue.height,Re,Fe,Ue.data):i.texImage2D(r.TEXTURE_2D,ve,Le,Ue.width,Ue.height,0,Re,Fe,Ue.data)}else if(b.isDataArrayTexture)if(Qe){if(it&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,Le,he.width,he.height,he.depth),Y)if(b.layerUpdates.size>0){const ve=A_(he.width,he.height,b.format,b.type);for(const we of b.layerUpdates){const Ie=he.data.subarray(we*ve/he.data.BYTES_PER_ELEMENT,(we+1)*ve/he.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,we,he.width,he.height,1,Re,Fe,Ie)}b.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,he.width,he.height,he.depth,Re,Fe,he.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,Le,he.width,he.height,he.depth,0,Re,Fe,he.data);else if(b.isData3DTexture)Qe?(it&&i.texStorage3D(r.TEXTURE_3D,Ae,Le,he.width,he.height,he.depth),Y&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,he.width,he.height,he.depth,Re,Fe,he.data)):i.texImage3D(r.TEXTURE_3D,0,Le,he.width,he.height,he.depth,0,Re,Fe,he.data);else if(b.isFramebufferTexture){if(it)if(Qe)i.texStorage2D(r.TEXTURE_2D,Ae,Le,he.width,he.height);else{let ve=he.width,we=he.height;for(let Ie=0;Ie<Ae;Ie++)i.texImage2D(r.TEXTURE_2D,Ie,Le,ve,we,0,Re,Fe,null),ve>>=1,we>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in r){const ve=r.canvas;if(ve.hasAttribute("layoutsubtree")||ve.setAttribute("layoutsubtree","true"),he.parentNode!==ve){ve.appendChild(he),y.add(b),ve.onpaint=we=>{const Ie=we.changedElements;for(const Me of y)Ie.includes(Me.image)&&(Me.needsUpdate=!0)},ve.requestPaint();return}if(r.texElementImage2D.length===3)r.texElementImage2D(r.TEXTURE_2D,r.RGBA8,he);else{const Ie=r.RGBA,Me=r.RGBA,qe=r.UNSIGNED_BYTE;r.texElementImage2D(r.TEXTURE_2D,0,Ie,Me,qe,he)}r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.LINEAR),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE)}}else if(Ze.length>0){if(Qe&&it){const ve=Ct(Ze[0]);i.texStorage2D(r.TEXTURE_2D,Ae,Le,ve.width,ve.height)}for(let ve=0,we=Ze.length;ve<we;ve++)Ue=Ze[ve],Qe?Y&&i.texSubImage2D(r.TEXTURE_2D,ve,0,0,Re,Fe,Ue):i.texImage2D(r.TEXTURE_2D,ve,Le,Re,Fe,Ue);b.generateMipmaps=!1}else if(Qe){if(it){const ve=Ct(he);i.texStorage2D(r.TEXTURE_2D,Ae,Le,ve.width,ve.height)}Y&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Re,Fe,he)}else i.texImage2D(r.TEXTURE_2D,0,Le,Re,Fe,he);v(b)&&O(re),De.__version=Te.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function tt(P,b,J){if(b.image.length!==6)return;const re=se(P,b),de=b.source;i.bindTexture(r.TEXTURE_CUBE_MAP,P.__webglTexture,r.TEXTURE0+J);const Te=s.get(de);if(de.version!==Te.__version||re===!0){i.activeTexture(r.TEXTURE0+J);const De=St.getPrimaries(St.workingColorSpace),fe=b.colorSpace===rs?null:St.getPrimaries(b.colorSpace),he=b.colorSpace===rs||De===fe?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(r.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,he);const Re=b.isCompressedTexture||b.image[0].isCompressedTexture,Fe=b.image[0]&&b.image[0].isDataTexture,Le=[];for(let Me=0;Me<6;Me++)!Re&&!Fe?Le[Me]=M(b.image[Me],!0,l.maxCubemapSize):Le[Me]=Fe?b.image[Me].image:b.image[Me],Le[Me]=Bt(b,Le[Me]);const Ue=Le[0],Ze=c.convert(b.format,b.colorSpace),Qe=c.convert(b.type),it=T(b.internalFormat,Ze,Qe,b.normalized,b.colorSpace),Y=b.isVideoTexture!==!0,Ae=Te.__version===void 0||re===!0,ve=de.dataReady;let we=U(b,Ue);ze(r.TEXTURE_CUBE_MAP,b);let Ie;if(Re){Y&&Ae&&i.texStorage2D(r.TEXTURE_CUBE_MAP,we,it,Ue.width,Ue.height);for(let Me=0;Me<6;Me++){Ie=Le[Me].mipmaps;for(let qe=0;qe<Ie.length;qe++){const Ve=Ie[qe];b.format!==Oi?Ze!==null?Y?ve&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,0,0,Ve.width,Ve.height,Ze,Ve.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,it,Ve.width,Ve.height,0,Ve.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Y?ve&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,0,0,Ve.width,Ve.height,Ze,Qe,Ve.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,it,Ve.width,Ve.height,0,Ze,Qe,Ve.data)}}}else{if(Ie=b.mipmaps,Y&&Ae){Ie.length>0&&we++;const Me=Ct(Le[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,we,it,Me.width,Me.height)}for(let Me=0;Me<6;Me++)if(Fe){Y?ve&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,Le[Me].width,Le[Me].height,Ze,Qe,Le[Me].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,it,Le[Me].width,Le[Me].height,0,Ze,Qe,Le[Me].data);for(let qe=0;qe<Ie.length;qe++){const Kt=Ie[qe].image[Me].image;Y?ve&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,0,0,Kt.width,Kt.height,Ze,Qe,Kt.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,it,Kt.width,Kt.height,0,Ze,Qe,Kt.data)}}else{Y?ve&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,Ze,Qe,Le[Me]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,it,Ze,Qe,Le[Me]);for(let qe=0;qe<Ie.length;qe++){const Ve=Ie[qe];Y?ve&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,0,0,Ze,Qe,Ve.image[Me]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,it,Ze,Qe,Ve.image[Me])}}}v(b)&&O(r.TEXTURE_CUBE_MAP),Te.__version=de.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function Ke(P,b,J,re,de,Te){const De=c.convert(J.format,J.colorSpace),fe=c.convert(J.type),he=T(J.internalFormat,De,fe,J.normalized,J.colorSpace),Re=s.get(b),Fe=s.get(J);if(Fe.__renderTarget=b,!Re.__hasExternalTextures){const Le=Math.max(1,b.width>>Te),Ue=Math.max(1,b.height>>Te);de===r.TEXTURE_3D||de===r.TEXTURE_2D_ARRAY?i.texImage3D(de,Te,he,Le,Ue,b.depth,0,De,fe,null):i.texImage2D(de,Te,he,Le,Ue,0,De,fe,null)}i.bindFramebuffer(r.FRAMEBUFFER,P),sn(b)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,re,de,Fe.__webglTexture,0,Wt(b)):(de===r.TEXTURE_2D||de>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&de<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,re,de,Fe.__webglTexture,Te),i.bindFramebuffer(r.FRAMEBUFFER,null)}function Yt(P,b,J){if(r.bindRenderbuffer(r.RENDERBUFFER,P),b.depthBuffer){const re=b.depthTexture,de=re&&re.isDepthTexture?re.type:null,Te=N(b.stencilBuffer,de),De=b.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;sn(b)?p.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Wt(b),Te,b.width,b.height):J?r.renderbufferStorageMultisample(r.RENDERBUFFER,Wt(b),Te,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,Te,b.width,b.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,De,r.RENDERBUFFER,P)}else{const re=b.textures;for(let de=0;de<re.length;de++){const Te=re[de],De=c.convert(Te.format,Te.colorSpace),fe=c.convert(Te.type),he=T(Te.internalFormat,De,fe,Te.normalized,Te.colorSpace);sn(b)?p.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Wt(b),he,b.width,b.height):J?r.renderbufferStorageMultisample(r.RENDERBUFFER,Wt(b),he,b.width,b.height):r.renderbufferStorage(r.RENDERBUFFER,he,b.width,b.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ut(P,b,J){const re=b.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(r.FRAMEBUFFER,P),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const de=s.get(b.depthTexture);if(de.__renderTarget=b,(!de.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),re){if(de.__webglInit===void 0&&(de.__webglInit=!0,b.depthTexture.addEventListener("dispose",z)),de.__webglTexture===void 0){de.__webglTexture=r.createTexture(),i.bindTexture(r.TEXTURE_CUBE_MAP,de.__webglTexture),ze(r.TEXTURE_CUBE_MAP,b.depthTexture);const Re=c.convert(b.depthTexture.format),Fe=c.convert(b.depthTexture.type);let Le;b.depthTexture.format===Aa?Le=r.DEPTH_COMPONENT24:b.depthTexture.format===Gs&&(Le=r.DEPTH24_STENCIL8);for(let Ue=0;Ue<6;Ue++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Ue,0,Le,b.width,b.height,0,Re,Fe,null)}}else ee(b.depthTexture,0);const Te=de.__webglTexture,De=Wt(b),fe=re?r.TEXTURE_CUBE_MAP_POSITIVE_X+J:r.TEXTURE_2D,he=b.depthTexture.format===Gs?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(b.depthTexture.format===Aa)sn(b)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,he,fe,Te,0,De):r.framebufferTexture2D(r.FRAMEBUFFER,he,fe,Te,0);else if(b.depthTexture.format===Gs)sn(b)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,he,fe,Te,0,De):r.framebufferTexture2D(r.FRAMEBUFFER,he,fe,Te,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function vt(P){const b=s.get(P),J=P.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==P.depthTexture){const re=P.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),re){const de=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,re.removeEventListener("dispose",de)};re.addEventListener("dispose",de),b.__depthDisposeCallback=de}b.__boundDepthTexture=re}if(P.depthTexture&&!b.__autoAllocateDepthBuffer)if(J)for(let re=0;re<6;re++)ut(b.__webglFramebuffer[re],P,re);else{const re=P.texture.mipmaps;re&&re.length>0?ut(b.__webglFramebuffer[0],P,0):ut(b.__webglFramebuffer,P,0)}else if(J){b.__webglDepthbuffer=[];for(let re=0;re<6;re++)if(i.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer[re]),b.__webglDepthbuffer[re]===void 0)b.__webglDepthbuffer[re]=r.createRenderbuffer(),Yt(b.__webglDepthbuffer[re],P,!1);else{const de=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Te=b.__webglDepthbuffer[re];r.bindRenderbuffer(r.RENDERBUFFER,Te),r.framebufferRenderbuffer(r.FRAMEBUFFER,de,r.RENDERBUFFER,Te)}}else{const re=P.texture.mipmaps;if(re&&re.length>0?i.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=r.createRenderbuffer(),Yt(b.__webglDepthbuffer,P,!1);else{const de=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Te=b.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Te),r.framebufferRenderbuffer(r.FRAMEBUFFER,de,r.RENDERBUFFER,Te)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function xt(P,b,J){const re=s.get(P);b!==void 0&&Ke(re.__webglFramebuffer,P,P.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),J!==void 0&&vt(P)}function dt(P){const b=P.texture,J=s.get(P),re=s.get(b);P.addEventListener("dispose",E);const de=P.textures,Te=P.isWebGLCubeRenderTarget===!0,De=de.length>1;if(De||(re.__webglTexture===void 0&&(re.__webglTexture=r.createTexture()),re.__version=b.version,d.memory.textures++),Te){J.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(b.mipmaps&&b.mipmaps.length>0){J.__webglFramebuffer[fe]=[];for(let he=0;he<b.mipmaps.length;he++)J.__webglFramebuffer[fe][he]=r.createFramebuffer()}else J.__webglFramebuffer[fe]=r.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){J.__webglFramebuffer=[];for(let fe=0;fe<b.mipmaps.length;fe++)J.__webglFramebuffer[fe]=r.createFramebuffer()}else J.__webglFramebuffer=r.createFramebuffer();if(De)for(let fe=0,he=de.length;fe<he;fe++){const Re=s.get(de[fe]);Re.__webglTexture===void 0&&(Re.__webglTexture=r.createTexture(),d.memory.textures++)}if(P.samples>0&&sn(P)===!1){J.__webglMultisampledFramebuffer=r.createFramebuffer(),J.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let fe=0;fe<de.length;fe++){const he=de[fe];J.__webglColorRenderbuffer[fe]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,J.__webglColorRenderbuffer[fe]);const Re=c.convert(he.format,he.colorSpace),Fe=c.convert(he.type),Le=T(he.internalFormat,Re,Fe,he.normalized,he.colorSpace,P.isXRRenderTarget===!0),Ue=Wt(P);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ue,Le,P.width,P.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,J.__webglColorRenderbuffer[fe])}r.bindRenderbuffer(r.RENDERBUFFER,null),P.depthBuffer&&(J.__webglDepthRenderbuffer=r.createRenderbuffer(),Yt(J.__webglDepthRenderbuffer,P,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Te){i.bindTexture(r.TEXTURE_CUBE_MAP,re.__webglTexture),ze(r.TEXTURE_CUBE_MAP,b);for(let fe=0;fe<6;fe++)if(b.mipmaps&&b.mipmaps.length>0)for(let he=0;he<b.mipmaps.length;he++)Ke(J.__webglFramebuffer[fe][he],P,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,he);else Ke(J.__webglFramebuffer[fe],P,b,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);v(b)&&O(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(De){for(let fe=0,he=de.length;fe<he;fe++){const Re=de[fe],Fe=s.get(Re);let Le=r.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Le=P.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Le,Fe.__webglTexture),ze(Le,Re),Ke(J.__webglFramebuffer,P,Re,r.COLOR_ATTACHMENT0+fe,Le,0),v(Re)&&O(Le)}i.unbindTexture()}else{let fe=r.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(fe=P.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(fe,re.__webglTexture),ze(fe,b),b.mipmaps&&b.mipmaps.length>0)for(let he=0;he<b.mipmaps.length;he++)Ke(J.__webglFramebuffer[he],P,b,r.COLOR_ATTACHMENT0,fe,he);else Ke(J.__webglFramebuffer,P,b,r.COLOR_ATTACHMENT0,fe,0);v(b)&&O(fe),i.unbindTexture()}P.depthBuffer&&vt(P)}function tn(P){const b=P.textures;for(let J=0,re=b.length;J<re;J++){const de=b[J];if(v(de)){const Te=I(P),De=s.get(de).__webglTexture;i.bindTexture(Te,De),O(Te),i.unbindTexture()}}}const nn=[],an=[];function cn(P){if(P.samples>0){if(sn(P)===!1){const b=P.textures,J=P.width,re=P.height;let de=r.COLOR_BUFFER_BIT;const Te=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,De=s.get(P),fe=b.length>1;if(fe)for(let Re=0;Re<b.length;Re++)i.bindFramebuffer(r.FRAMEBUFFER,De.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Re,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,De.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Re,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,De.__webglMultisampledFramebuffer);const he=P.texture.mipmaps;he&&he.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,De.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,De.__webglFramebuffer);for(let Re=0;Re<b.length;Re++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(de|=r.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(de|=r.STENCIL_BUFFER_BIT)),fe){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,De.__webglColorRenderbuffer[Re]);const Fe=s.get(b[Re]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Fe,0)}r.blitFramebuffer(0,0,J,re,0,0,J,re,de,r.NEAREST),m===!0&&(nn.length=0,an.length=0,nn.push(r.COLOR_ATTACHMENT0+Re),P.depthBuffer&&P.resolveDepthBuffer===!1&&(nn.push(Te),an.push(Te),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,an)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,nn))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),fe)for(let Re=0;Re<b.length;Re++){i.bindFramebuffer(r.FRAMEBUFFER,De.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Re,r.RENDERBUFFER,De.__webglColorRenderbuffer[Re]);const Fe=s.get(b[Re]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,De.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Re,r.TEXTURE_2D,Fe,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,De.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&m){const b=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[b])}}}function Wt(P){return Math.min(l.maxSamples,P.samples)}function sn(P){const b=s.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Z(P){const b=d.render.frame;x.get(P)!==b&&(x.set(P,b),P.update())}function Bt(P,b){const J=P.colorSpace,re=P.format,de=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||J!==kc&&J!==rs&&(St.getTransfer(J)===Ft?(re!==Oi||de!==hi)&&nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",J)),b}function Ct(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(h.width=P.naturalWidth||P.width,h.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(h.width=P.displayWidth,h.height=P.displayHeight):(h.width=P.width,h.height=P.height),h}this.allocateTextureUnit=B,this.resetTextureUnits=ce,this.getTextureUnits=pe,this.setTextureUnits=Q,this.setTexture2D=ee,this.setTexture2DArray=_e,this.setTexture3D=Ee,this.setTextureCube=w,this.rebindTextures=xt,this.setupRenderTarget=dt,this.updateRenderTargetMipmap=tn,this.updateMultisampleRenderTarget=cn,this.setupDepthRenderbuffer=vt,this.setupFrameBufferTexture=Ke,this.useMultisampledRTT=sn,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function XA(r,e){function i(s,l=rs){let c;const d=St.getTransfer(l);if(s===hi)return r.UNSIGNED_BYTE;if(s===Gh)return r.UNSIGNED_SHORT_4_4_4_4;if(s===Hh)return r.UNSIGNED_SHORT_5_5_5_1;if(s===_v)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===vv)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===mv)return r.BYTE;if(s===gv)return r.SHORT;if(s===Zo)return r.UNSIGNED_SHORT;if(s===Bh)return r.INT;if(s===Zi)return r.UNSIGNED_INT;if(s===Xi)return r.FLOAT;if(s===Ta)return r.HALF_FLOAT;if(s===xv)return r.ALPHA;if(s===yv)return r.RGB;if(s===Oi)return r.RGBA;if(s===Aa)return r.DEPTH_COMPONENT;if(s===Gs)return r.DEPTH_STENCIL;if(s===Sv)return r.RED;if(s===Vh)return r.RED_INTEGER;if(s===Vs)return r.RG;if(s===kh)return r.RG_INTEGER;if(s===Xh)return r.RGBA_INTEGER;if(s===zc||s===Ic||s===Fc||s===Bc)if(d===Ft)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===zc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Ic)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Fc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Bc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===zc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Ic)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Fc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Bc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===th||s===nh||s===ih||s===ah)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===th)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===nh)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===ih)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===ah)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===sh||s===rh||s===oh||s===lh||s===ch||s===Hc||s===uh)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(s===sh||s===rh)return d===Ft?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===oh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===lh)return c.COMPRESSED_R11_EAC;if(s===ch)return c.COMPRESSED_SIGNED_R11_EAC;if(s===Hc)return c.COMPRESSED_RG11_EAC;if(s===uh)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===fh||s===dh||s===hh||s===ph||s===mh||s===gh||s===_h||s===vh||s===xh||s===yh||s===Sh||s===Mh||s===bh||s===Eh)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(s===fh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===dh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===hh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===ph)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===mh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===gh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===_h)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===vh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===xh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===yh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Sh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Mh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===bh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Eh)return d===Ft?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Th||s===Ah||s===Rh)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(s===Th)return d===Ft?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Ah)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Rh)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Ch||s===wh||s===Vc||s===Dh)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(s===Ch)return c.COMPRESSED_RED_RGTC1_EXT;if(s===wh)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Vc)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Dh)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ko?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const WA=`
void main() {
